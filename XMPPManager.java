...
import com.xmessenger.SQLite.Messages;
import com.xmessenger.android.ConnectionState;
import com.xmessenger.android.LocaleController;
import com.xmessenger.android.OSUtilities;
import com.xmessenger.messenger.DispatchQueue;
import com.xmessenger.messenger.FileLog;
import com.xmessenger.messenger.NotificationCenter;
import com.xmessenger.messenger.R;
import com.xmessenger.messenger.TLRPC;
import com.xmessenger.messenger.UserConfig;
import com.xmessenger.messenger.Utilities;
import com.xmessenger.objects.MessageObject;
import com.xmessenger.ui.ApplicationLoader;
import com.xmessenger.xmpp.Util.ConnectivityManagerUtil;
import com.xmessenger.xmpp.call.CallParameter;
import com.xmessenger.xmpp.customProviders.Location;
import com.xmessenger.xmpp.customProviders.OutOfBandData;
import com.xmessenger.xmpp.customProviders.PhoneCall;
import com.xmessenger.xmpp.customProviders.UserLocationExtension;
...
public class XMPPManager /*implements PacketListener*/ {
    ...
    private com.xmessenger.xmpp.MessageListener packetListener;
    ...
    // todo add feature to recall message you sent by accident
 ...
 public  SSLContext getSSLContext () {
    ...
    public void initConnection() {
        ...
        if (connectionSettingsObsolete || connection == null || connection.isConnected()) {
            ...
            FileLog.e("x-messenger", String.format("Initializing connection to server %1$s port %2$d\n", HOST, SPORT));
            //SSLContext sc;
            try {
           ...
           */
           ...
           /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            try {
                ...
                /*packetListener = new com.xmessenger.xmpp.MessageListener();
    ...
    private void onConnectionEstablished(XMPPTCPConnection mConnection) {
           ...
           ////// connection.addConnectionCreationListener(createConnectionListener());
            ...
            if (connectionState != ConnectionState.ONLINE) {
                ...
                Utilities.RunOnUIThread(new Runnable() {
                    ...
                    public void run() {
                        NotificationCenter.getInstance().postNotificationName(connectionStateDidChanged);
                        //  Toast.makeText(ApplicationLoader.applicationContext, "xmessenger is connected", Toast.LENGTH_LONG).show();
                    }
                });
            }
            sendUnsentMessages();
       ...
       /* Utilities.globalQueue.postRunnable(new Runnable() {
            @Override
            public void run() {
                FileLog.e("XMPPManager", "CreateGroup");
                ArrayList<String> jids= new ArrayList<String>();
                jids.add("962797982823@xmessenger/android");
                jids.add("962795928793@xmessenger/android");
                jids.add("962797982824@xmessenger/android");
                MucManager.getInstance().createRoomAndSaveToDb("xmessenger", jids);
            }
        }, 5000);
            */
    ...
    private boolean connectAndAuth(XMPPTCPConnection connection) {
        ...
        try {
            ...
            FileLog.e("XMPPManager", "Login with " + UserConfig.currentUser.phone + "@xmessenger\\" + RESOURCE);
            //UserConfig.loadConfig();
            connection.login();
   ...
   /* @Override
    ...
    public ConnectionListener createGeneralConnectionListener() {
        connectionGeneralListener = new ConnectionListener() {
            ...
            public void connectionClosed() {
                ...
                currentPresence=5;
                if (connectionState != ConnectionState.CONNECTING && connectionState != ConnectionState.RECONNECT_NETWORK /*&& com.xmessenger.xmpp.MessagesController.isScreenOn*/) {
            ...
            public void run() {
                ...
                */
                ...
                try {
                    ...
                    e.printStackTrace();
                    FileLog.e("xmessenger create Account", e.toString());

                }
                //onConnectionEstablished(xmppConnection);

                //openConnection();
                FileLog.d("xmessenger", "Creating account");
                if (xmppConnection.isConnected()) {
                    FileLog.d("xmessenger", "isConnected=true");
                    ...
                    try {
                        try {
                            accountManager.createAccount(JidCreate.bareFrom(username+"@xmessenger").getLocalpartOrNull(), password, attributes);
                        } catch (Exception e) {
                            if (e.getMessage().equals("conflict")) {
                                FileLog.e("x-messenger", " User already exist");
                            }
                        }
                        Utilities.RunOnUIThread(new Runnable() {
                            @Override
                        ...
                        FileLog.e("x-messenger", " XmppManager.accountCreated");
                        FileLog.e("x-messenger", " currentUser name : " + userToRegister.first_name);

                        UserConfig.clearConfig();
                        //com.xmessenger.messenger.MessagesStorage.getInstance().cleanUp();
                        //com.xmessenger.messenger.MessagesController.getInstance().cleanUp();
                        ...
                        //com.xmessenger.messenger.MessagesStorage.getInstance().putUsersAndChats(users, null, true, true);
    ...
    public boolean addUser(String userName, String name) {
        //AuthenticateUser();
        FileLog.e("x-messenger", "addUser to roaster " + userName);
        ...
        try {
            ...
            FileLog.e("x-messenger", "addUser to roaster " + e.toString());
            return false;
        }
    }
    ...
    public void sendFileOutOFBand(final String jid, final String filePath, final Messages newMsg) {
        /*xmppQueue.postRunnable(new Runnable() {
            ...
            public void run() {*/
                ...
                String path = "/xmessenger/media/xmessenger Images/received";
    ...
    private void sendMessage(final String message, final double lat, final double lon, final TLRPC.TL_photo photo,
        ...
        try {
            ...
            if (message != null) {//if not null the message type is text
                ...
                FileLog.e("xmessenger tl_messageMediaPhoto", photo.sizes.size() + "");
            } else if (video != null) {
                newMsg.tl_message = new TLRPC.TL_message();
                ...
                FileLog.e("xmessenger audio.path", audio.path);
                ...
                FileLog.e("xmessenger tl_message.media.audio", audio.duration + "");
                ...
                type = 4;
                    ...
                    /*if (newMsg == null) {
                        FileLog.e("xmessenger newMsg == null", "newMsg == null");
                        return;
                    }*/
            ...
            FileLog.e("xmessenger newMsg == null", "putMessage newMsg");
            //  newMsg.setSend_state(XmppManager.MESSAGE_SEND_STATE_SENDING);
            ...
            if (type == 0 || type == 4) {
                ...
                FileLog.e("xmessenger newMsg == null", "sending file");
      ...
      /*  long[] vibrate = {0, 100, 200, 300};
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(ApplicationLoader.applicationContext)
                ...
                .setAutoCancel(true)// clear notification after click
                        // .setSound(alarmSound)
                .setSound(Uri.parse("android.resource://com.xmessenger.app/" + R.raw.electronic))
                .setVibrate(vibrate);
        ...
        Utilities.stageQueue.postRunnable(new Runnable() {
            ...
            public void run() {
                if (paused) {
                    ...
                    FileLog.e("x-messenger", "reset timers by application moved to foreground");
                }
            }
        });
    }
